...
function ajaxFileUpload(cid,mid,uniqu){
  document.getElementById("STATU_"+uniqu).innerHTML="<img src=\"./templates/bootstrap/img/loading-mini.gif\">";
  $.ajaxFileUpload
	 (
	   {
			url:'./request.php?nb=1&cid='+cid+"&mid="+mid,
			secureuri:false,
			fileElementId:'new_custom_mod',
			dataType: 'plain',
			...
			{
				document.getElementById("CONTENT_"+uniqu).innerHTML=e;
			}
	   }
	)
	return false;
