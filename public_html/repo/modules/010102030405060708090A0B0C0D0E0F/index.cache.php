<? if (!class_exists('template')) die('Access Denied');$template->getInstance()->check('index.htm', '170d32fd9cbdd0054adfc26864d6fd74', 1395472220);?>
<? if($e) { ?>
...
<? if(('/' != $basedir)) { ?>
<tr><td><input type="checkbox" disabled="true"></td><td></td><td></td><td></td><td></td><td></td><td><a href="#TOP_<?=$UNIQU?>" onclick="javascript:mod_request('<?=$CID?>','<?=$MID?>','<?=$UNIQU?>','basedir=<?=$basedir?>/../',0,0);">..\</a></td></tr>
